...
object EnteryPoint extends App {

  val conf = ConfigFactory.load()
  val actorSystem = ActorSystem("Dwag-Actor-System")
  val materializer: ActorMaterializer = ActorMaterializer()(actorSystem)
  implicit val logger: LoggingAdapter = Logging(actorSystem, "Dwag")
  ...
  try {
    ...
    val dbLayers: DBLayer = new DBLayer(tabularConnectionInstantiator.connectionProvider)
